<x-agent-dashboard.dashboard-layout >
    <!-- Form Content -->
    @vite(['resources/js/agents/updateProperty.js'])
        <div class="p-6">
            <form action="/dashboard/property/update/{{ $property->id }}" method="POST" enctype="multipart/form-data" id="propertyForm" class="space-y-6">
                ...
                <div class="form-card rounded-2xl p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="type" class="form-input w-full px-4 py-3 rounded-lg text-white" value="{{ $property->type??old('type') }}" required>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="flex space-x-2">
                                <input 
                                    ...
                                    value="{{ $property->location??old('location') }}"
                                    required>
                        ...
                        <div>
                            <label class="block text-gray-300 text-sm font-medium mb-2">longitude *</label>
                             <input 
                                ...
                                class="form-input w-full px-4 py-3 rounded-lg text-white" 
                                placeholder="12.5156" 
                                value="{{ $property->longitude??old('longitude') }}"
                                required>
                        ...
                        <div class="currency-input">
                            ...
                            <input 
                                ...
                                class="form-input w-full px-4 py-3 rounded-lg text-white" 
                                placeholder="12.5156" 
                                value="{{ $property->latitude??old('latitude') }}" 
                                required>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                        <div>
                            ...
                            <input 
                                ...
                                min="0" 
                                max="20"
                                value="{{ $property->details->bed_rooms??old('bedrooms') }}"
                                >
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                name="bathrooms" 
                                class="form-input w-full px-4 py-3 rounded-lg text-white" 
                                value="{{ $property->details->bath_rooms??old('bathrooms') }}"
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                name="area" 
                                class="form-input w-full px-4 py-3 rounded-lg text-white" 
                                value="{{ $property->details->area_size??old('area') }}"
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                name="yearBuilt" 
                                class="form-input w-full px-4 py-3 rounded-lg text-white" 
                                value="{{ $property->details->year_built??old('yearBuilt') }}"
                        ...
                        <div class="checkbox-group">
                            <label class="checkbox-item">
                                <input type="checkbox" name="amenities[]" value="parking" class="sr-only" 
                                    {{ $property->details->parking ? 'checked' : '' }}
                                >
                            ...
                            <label class="checkbox-item">
                                <input type="checkbox" name="amenities[]" value="balcony" class="sr-only"
                                    {{ $property->details->balcony ? 'checked' : '' }}
                                >
                                <div class="checkbox-content flex-1">
                                    <div class="flex items-center">
                                        <div class="checkbox-icon w-8 h-8 bg-gray-600 rounded-lg flex items-center justify-center mr-3 transition-all">
                            ...
                            <label class="checkbox-item">
                                <input type="checkbox" name="amenities[]" value="pool" class="sr-only"
                                    {{ $property->details->swiming_pool ? 'checked' : '' }}
                                >
                                <div class="checkbox-content flex-1">
                                    <div class="flex items-center">
                                        <div class="checkbox-icon w-8 h-8 bg-gray-600 rounded-lg flex items-center justify-center mr-3 transition-all">
                            ...
                            <label class="checkbox-item">
                                <input type="checkbox" name="amenities[]" value="security" class="sr-only"
                                    {{ $property->details->security ? 'checked' : '' }}
                                >
                                <div class="checkbox-content flex-1">
                                    <div class="flex items-center">
                                        <div class="checkbox-icon w-8 h-8 bg-gray-600 rounded-lg flex items-center justify-center mr-3 transition-all">
                            ...
                            <label class="checkbox-item">
                                <input type="checkbox" name="amenities[]" value="garden" class="sr-only"
                                    {{ $property->details->garden ? 'checked' : '' }}
                                >
                                <div class="checkbox-content flex-1">
                                    <div class="flex items-center">
                                        <div class="checkbox-icon w-8 h-8 bg-gray-600 rounded-lg flex items-center justify-center mr-3 transition-all">
                ...
                <div class="form-card rounded-2xl p-6">
                    ...
                    <div class="upload-area rounded-xl p-8 text-center mb-6" id="uploadArea">
                        ...
                        <p class="text-red-300 text-sm mb-4">
                            Caution: If you upload any image, all the previous images will be replaced by the new ones.
                        </p>
